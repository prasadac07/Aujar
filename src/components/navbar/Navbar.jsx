...
export default function Navbar() {
  ...
  return (
    <>
      <div className=" hidden md:flex p-4 shadow-xl flex justify-between text-green-600 font-bold">
        <ul className="flex justify-evenly w-2/3 ">
          ...
          <li className="my-auto">
            <NavLink to="/add">Add Trip</NavLink>
          </li>
          <li className="my-auto">
            <NavLink to="/get">Search Trip</NavLink>
          </li>
